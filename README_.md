# ZielonyOS
Welcome to ZielonyOS! My own Distro with everything being an exotic choice!
...
also this distro can also use progman, just select progman in the display manager's selector and use progman! ZielonyOS is reccomended to be used with progman!
ZielonyOS can also alternatively use Window Maker, but it's not the full experience.

The Shell is also exotic, ZielonyOS is the only distro that uses Nushell! Shout out to Nushell and @kspatlas (atlas the genode fanatic) in Discord!
The Display Manager is already a exotic choice too.

ZielonyOS comes with Wallpapers, to check them out, go to Window Maker, then right click, select Appearances > Background > Images
...
# How to operate with ZielonyOS
Right now, I couldn't get the Calamares installer to cooperate with the installer, if you can do it yourself,
then please modifiy the ZielonyOS system and get the installer to work yourself!

(and also leave some steps on how to install ZielonyOS)

Because of the way of sharing ZielonyOS, it cannot be installed on bare metal,
